...
@include('page.projects.partials.status_stepper')
@include('page.projects.partials.milestones')
@include('page.projects.partials.documents')
@include('page.projects.partials.emi_actions')
@include('page.projects.partials.activity')
@if($project->project_note)
<div class="crm-section mt-3">
    <div class="fw-semibold mb-2">Project Notes</div>
